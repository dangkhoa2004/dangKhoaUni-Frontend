        ...
        <div class="flex-1 flex flex-col min-w-0">
            ...
            <main class="p-6 md:p-10 max-w-[1400px] mx-auto w-full space-y-8">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <h1 class="text-2xl md:text-3xl font-black text-gray-900 uppercase tracking-tight">Thiết lập dữ
                            liệu nền</h1>
                        <p class="text-gray-500 mt-1">Quản lý danh mục học kỳ, khoa, ngành và các cấu hình hệ thống quan
                            trọng.</p>
                    </div>
                    <div class="flex items-center gap-3">
                        <button
                            class="flex items-center gap-2 px-6 py-3 bg-white border border-gray-200 text-gray-700 font-bold rounded-2xl hover:bg-gray-50 transition-all shadow-sm active:scale-95 text-sm">
                        ...
                        <button
                            class="flex items-center gap-2 px-6 py-3 bg-gray-900 text-white font-black rounded-2xl hover:bg-black transition-all shadow-lg active:scale-95 text-sm">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-200">
                            <h3
                                class="font-black text-gray-900 uppercase text-xs tracking-widest mb-6 flex items-center gap-2">
                                ...
                                <table class="w-full border-collapse">
                                    ...
                                    <tbody class="divide-y divide-gray-50">
                                        <tr v-for="sem in semesters" :key="sem.id" class="group">
                                            ...
                                            <td class="py-4 text-center text-sm text-gray-500 font-medium">{{ sem.year
                                                }}</td>
                                            <td class="py-4 text-center">
                                                <span
                                                    :class="sem.isActive ? 'bg-emerald-50 text-emerald-600' : 'bg-gray-100 text-gray-400'"
                                            ...
                                            <td class="py-4 text-right">
                                                <button
                                                    class="p-2 text-gray-400 hover:text-indigo-600 transition-colors"><svg
                                                ...
                                                <button
                                                    class="p-2 text-gray-400 hover:text-rose-600 transition-colors"><svg
                                                        class="w-4 h-4" fill="none" stroke="currentColor"
                                                        viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                ...
                                <div v-for="dept in departments" :key="dept.id"
                                    ...
                                    <div class="bg-gray-50/50 p-5 flex items-center justify-between">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-gray-400 group-hover:text-indigo-600 shadow-sm transition-colors">
                                            ...
                                            <div>
                                                ...
                                                <p
                                                    ...
                                                    {{ dept.majors.length }} Ngành đào tạo</p>
                                            </div>
                                        </div>
                                        <button
                                            class="p-2 bg-white rounded-xl border border-gray-100 text-gray-400 hover:text-gray-900 shadow-sm transition-all"><svg
                                    ...
                                    <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-3 bg-white">
                                        <div v-for="major in dept.majors" :key="major"
                                            ...
                                            <div
                                                ...
                                                <button class="p-1.5 hover:text-indigo-600"><svg class="w-3.5 h-3.5"
                                                ...
                                                <button class="p-1.5 hover:text-rose-600"><svg class="w-3.5 h-3.5"
                                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                            d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16">
                    ...
                    <div class="space-y-8">
                        ...
                        <div class="bg-gray-900 p-8 rounded-[2.5rem] text-white shadow-xl relative overflow-hidden">
                            <h3 class="text-xs font-black uppercase tracking-[0.2em] opacity-60 mb-8">Trạng thái Cổng
                                thông tin</h3>

                            <div class="space-y-6 relative z-10">
                                <div
                                    class="flex items-center justify-between p-4 rounded-3xl bg-white/5 border border-white/10">
                                    <div>
                        ...
                        <div class="bg-white p-8 rounded-[2.5rem] shadow-sm border border-gray-200">
                            <h3 class="font-black text-gray-900 uppercase text-xs tracking-widest mb-6">Backup & Bảo mật
                            </h3>
                            <div class="space-y-4">
                                <button
                                    class="w-full py-4 px-6 rounded-2xl bg-gray-50 border border-gray-100 flex items-center gap-4 hover:bg-gray-100 transition-all text-left">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[9px] text-gray-400 font-bold uppercase">Lần cuối: 2 giờ trước
                                        </p>
                                    </div>
                                </button>
                                <button
                                    ...
                                    <div>
                                        ...
                                        <p class="text-[9px] text-gray-400 font-bold uppercase">1,240 Phiên đang chạy
                                        </p>
                                    </div>
                                </button>
                            </div>
